...
fn fe_tobytes(h: fe) -> u256 {
  ...
  */
  ...
  s[2] = bitcast<u32>(
      (((h2 >> 13) & BYTE_MASK) << 24)
    | (( ((h2 >> 21) | (h3 << 5)) & BYTE_MASK ) << 16)
    | (((h3 >>  3) & BYTE_MASK) <<  8)
    | ((h3 >> 11) & BYTE_MASK)
  );

  // s[3] = bytes 12,13,14,15
  s[3] = bitcast<u32>(
      ((((h3 >> 19) | (h4 << 6)) & BYTE_MASK) << 24)
    | (((h4 >>  2) & BYTE_MASK) << 16)
    | (((h4 >> 10) & BYTE_MASK) <<  8)
    | ((h4 >> 18) & BYTE_MASK)
  );

  // s[5] = bytes 20,21,22,23
  s[4] = bitcast<u32>(
      (((h5 >>  0) & BYTE_MASK) << 24)
    | (((h5 >>  8) & BYTE_MASK) << 16)
    | (((h5 >> 16) & BYTE_MASK) <<  8)
    | ( ((h5 >> 24) | (h6 << 1)) & BYTE_MASK )
  );
  ...
  s[5] = bitcast<u32>(
      (((h6 >>  7) & BYTE_MASK) << 24)
    | (((h6 >> 15) & BYTE_MASK) << 16)
    | (( ((h6 >> 23) | (h7 << 3)) & BYTE_MASK ) <<  8)
    | ((h7 >>  5) & BYTE_MASK)
  );

  // s[6] = bytes 24,25,26,27
  s[6] = bitcast<u32>(
      (((h7 >> 13) & BYTE_MASK) << 24)
    | (( ((h7 >> 21) | (h8 << 4)) & BYTE_MASK ) << 16)
    | (((h8 >>  4) & BYTE_MASK) <<  8)
    | ((h8 >> 12) & BYTE_MASK)
  );

  // s[7] = bytes 28,29,30,31
  s[7] = bitcast<u32>(
      ((((h8 >> 20) | (h9 << 6)) & BYTE_MASK) << 24)
    | (((h9 >> 2) & BYTE_MASK) << 16)
    | (((h9 >> 10) & BYTE_MASK) <<  8)
    | ((h9 >> 18) & BYTE_MASK)
  );
