/*
  This is a slightly modified implementation of signed 64-bit integers by Andrea Frasca,
  licensed under the MIT license, available at https://github.com/Gold18K/WebGPU-WGSL-64bit-BigInt
*/
...
fn i64_left_shift(_n: i64, _s: u32) -> i64 {
    var r = _n;
    let shiftLoops    = u32(floor(f32(_s) / 31));
    let shiftLastLoop = u32(_s % 31);
